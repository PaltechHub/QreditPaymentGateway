 ...
 * @method static \Qredit\LaravelQredit\Contracts\RedirectUrlStore redirectUrls()
 * @method static void rememberRedirectUrls(string $paymentReference, \Qredit\LaravelQredit\Tenancy\QreditRedirectUrls $urls, ?string $tenantId = null)
 * @method static ?\Qredit\LaravelQredit\Tenancy\QreditRedirectUrls resolveRedirectUrls(string $paymentReference, ?string $tenantId = null)
 * @method static void forgetRedirectUrls(string $paymentReference, ?string $tenantId = null)
 ...
 * @method static bool verifyWebhookSignature(array $payload, string $authorizationHeader, ?string $rawBody = null)
 * @method static array processWebhook(array $payload, ?string $authorizationHeader = null, ?string $rawBody = null)
