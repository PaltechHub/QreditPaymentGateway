...
- [REDIRECT_URLS.md](REDIRECT_URLS.md) — persist success/cancel/failure/pending URLs per payment reference
- [WEBVIEW.md](WEBVIEW.md) — mobile-app integration (Android / iOS WebView + deep-link return)
...
| "How do I send the customer to a specific URL after payment?" | [REDIRECT_URLS.md](REDIRECT_URLS.md) |
| "How do I embed Qredit in a mobile-app WebView?" | [WEBVIEW.md](WEBVIEW.md) |
